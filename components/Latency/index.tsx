  ...
  ({ started = false, botStatus, statsAggregator }) => {
      ...
      async function loadVad() {
        try {
          if (
            ...
            console.error(
              'AudioWorkletProcessor or AudioContext is not supported in this environment.'
            );
            return;
          }
          ...
          const AudioWorkletURL = (
            await import('web-vad/dist/worklet?worker&url')
          ).default;
    ...
    return (
      <div className="w-full flex flex-row p-2">
        <div
          className={
            started ? userCx : 'flex flex-col bg-white p-2 md:p-3 rounded-2xl'
          }
        >
