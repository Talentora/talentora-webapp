...
export function AiRecruiterSetup() {
  const [questions, setQuestions] = useState<Question[]>([
    {
      id: 1,
      text: 'Tell me about a time you faced a challenging problem at work.',
      type: 'behavioral',
      mustAsk: false
    },
    {
  ...
  const [newQuestionType, setNewQuestionType] =
    useState<QuestionType>('behavioral');
  ...
  const handleToggleMustAsk = (id: number) => {
    setQuestions(
      questions.map((q) => (q.id === id ? { ...q, mustAsk: !q.mustAsk } : q))
    );
  };
                        ...
                        <div className="flex flex-col space-y-4">
                          ...
                          >
                            ...
                            <SelectContent className="bg-popover text-popover-foreground">
                              ...
                              <SelectItem value="team-based">
                                Team-based
                              </SelectItem>
                              <SelectItem value="industry-knowledge">
                                Industry Knowledge
                              </SelectItem>
                            </SelectContent>
                          </Select>
