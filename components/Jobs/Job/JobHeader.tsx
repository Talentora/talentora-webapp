            ...
            <span className="flex items-center">
              {job.departments.length > 0
                ? job.departments.map((dept) => (
                    <span
                      key={dept.name}
                      className="mr-2 inline-flex items-center px-3 py-1 text-xs font-medium text-gray-800 dark:text-gray-500 bg-input rounded-full"
                    >
            ...
            <CardDescription className="text-sm leading-7 text-primary/70">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: job.description || 'missing',
                }}
              />
            </CardDescription>
          </section>
