            ...
            <div className="space-y-4">
              <div>
                <p className="text-sm text-muted-foreground">
                  You have <strong>{interviewConfig.interview_questions?.length || 0}</strong> questions configured for your <strong>{interviewConfig.interview_type || 'standard'}</strong> interview.
                </p>
              </div>
              <Separator />
              <div className="space-y-2">
                {interviewConfig.interview_questions?.slice(0, 2).map((question, index) => (
                ...
                {interviewConfig.interview_questions?.length > 2 && (
                  <p className="text-sm text-muted-foreground">
                    ...
                  </p>
                )}
