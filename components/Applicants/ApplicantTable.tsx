...
export default function ApplicantTable({ applicants, onSelectApplicant }: ApplicantTableProps) {
  return (
    <Table>
      <TableHeader>
        <TableRow>
      ...
      <TableBody>
        {applicants.map((application) => (
          <TableRow key={application.id} onClick={() => onSelectApplicant(application)} className="cursor-pointer">
