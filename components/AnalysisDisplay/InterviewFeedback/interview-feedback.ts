...
export const interviewFeedback: InterviewFeedback = {
  technical: {
    ...
    knowledge_depth: {
      score: 9.0,
      explanation: "Sarah's experience with tools like React, TypeScript, and GraphQL shows strong front-end technical knowledge. She discusses using React DevTools and Chrome's Performance tab, which aligns with industry-standard practices for debugging and performance profiling. Her ability to work with both frontend and backend technologies displays a comprehensive understanding of the tech stack. Her contribution to open-source projects further emphasizes her depth of knowledge.",
      supporting_quotes: [
    ...
    best_practices: {
      score: 9.0,
      explanation: "Sarah shows familiarity with state management, testing, and optimization strategies. She uses Redux with Redux Toolkit and is exploring Zustand, both popular choices. Her testing pyramid approach is aligned with best practices, as is her attention to accessibility.",
      supporting_quotes: [
    ...
    system_design: {
      score: 8.0,
      explanation: "While Sarah shows strong practical coding and optimization skills, the transcript lacks deep exploration of system architecture principles, such as microservices or cloud-native design. Nonetheless, her experience with continuous integration suggests a solid foundation.",
      supporting_quotes: [
    ...
    testing_approach: {
      score: 10.0,
      explanation: "Sarah's testing strategy follows a comprehensive testing pyramid with unit, integration, and end-to-end tests. Her use of Jest, React Testing Library, and Cypress reflects robust testing aligned with business-critical needs.",
      supporting_quotes: [
  ...
  communication: {
    ...
    clarity: {
      score: 9.0,
      explanation: "Sarah articulates her experiences and thoughts clearly, using straightforward language that conveys her technical skills effectively. She provides concrete examples to support her statements, enhancing understanding.",
      supporting_quotes: [
        "I implemented code splitting, lazy loading, and virtualization for long lists.",
    ...
    articulation: {
      score: 8.0,
      explanation: "While Sarah explains complex concepts like performance profiling and state management well, there are moments where she could have broken down her explanations further for clarity, especially when discussing technical methodologies.",
      supporting_quotes: [
    ...
    listening_skills: {
      score: 8.0,
      explanation: "Sarah demonstrates listening skills by answering questions thoroughly and appropriately responding to prompts, indicating she understands what is being asked. However, there were few follow-up questions or clarifications.",
      supporting_quotes: [
    ...
    professionalism: {
      score: 9.0,
      explanation: "Throughout the interview, Sarah maintains a professional tone and shows respect for the interviewer's time. Her engagement in the discussion and knowledge of the subject matter emphasizes her professionalism.",
      supporting_quotes: [
        "I'm a strong advocate for testing and follow a pyramid approach.",
