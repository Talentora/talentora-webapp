    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 ">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48">
          {' '}
          {/* Gradient blends to page background */}
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl text-black">
                  We're on a mission to revolutionize the hiring experience
                  using AI.
                </p>
              </div>
            </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          {' '}
          {/* Explicit background color applied */}
          <div className="container px-4 md:px-6">
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              ...
              <Card>
                <CardContent className="flex flex-col items-center space-y-4 p-6 text-black">
                  ...
                  <p className="text-center text-muted-foreground">
                    A diverse group of students that hope to revolutionize
                    hiring.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center space-y-4 p-6 text-black">
                  ...
                  <p className="text-center text-muted-foreground">
                    Founded in 2024, we're an agile group of builders hoping to
            ...
            <div className="grid gap-10 lg:grid-cols-2">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  create innovative solutions that make a difference. Over the
                  years, We&apos;ve grown from a small team of dreamers to a
                  global organization, but our core mission remains the same.
                </p>
                <p className="text-muted-foreground">
                  We&apos;ve faced challenges, celebrated victories, and learned
                  valuable lessons along the way. Our journey is a testament to
                  the power of perseverance, creativity, and teamwork.
                </p>
              </div>
