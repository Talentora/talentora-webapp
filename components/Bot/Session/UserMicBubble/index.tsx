...
export default function UserMicBubble({
  ...
  const cx = clsx(
    muted && active && "opacity-100 bg-red-500 bg-radial-gradient-red-500-red-600 animate-pulseText border-6 border-red-200 outline-6 outline-red-400",
    !active && "pointer-events-none cursor-not-allowed",
    canTalk && "opacity-100 bg-primary-500 bg-radial-gradient-primary-500-primary-600 border-6 border-primary-200 outline-6 outline-primary-400 outline-offset-4"
  );
